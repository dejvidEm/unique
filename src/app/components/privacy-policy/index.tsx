                ...
                <div className="container">
                    <div className='flex flex-col gap-1.5 py-10 md:py-20'>
                        ...
                        <div className="my-6">
                            ...
                            <p>
                                We do not collect financial information (such as credit card details or security codes). All payments are handled through a third-party provider. If applicable, please refer to the provider's website for their privacy policy.
                            </p>
                        </div>
                        ...
                        <div className="my-6">
                            ...
                            <p className="mt-6">
                                As noted, we do not collect financial details directly. Payments are processed via third-party providers. Please review the provider's privacy policy on their website for details.
                            </p>
                        </div>
                    </div>
                </div>
